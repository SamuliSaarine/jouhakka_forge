...
//COPIED FROM MATERIAL INTERACTIVE VIEWER
//(I need to modify it to fit our needs)
...
class _MyInteractiveViewerState extends State<MyInteractiveViewer>
  ...
  void _receivedPointerSignal(PointerSignalEvent event) {
    ...
    if (event is PointerScrollEvent) {
      ...
      //If mouse scroll and shift is down, switch to horizontal pan. Added by me
      ...
      if (!_gestureIsSupported(_GestureType.pan)) {
        widget.onInteractionUpdate?.call(
          ScaleUpdateDetails(
            focalPoint: global - scrollDelta,
            localFocalPoint: local - scrollDelta,
      ...
      scaleChange = event.scale.clamp(0.84, 1.16); //Clamp added by me
    } else {
      return;
    }
